...
class CreateViewChartHistoryTable extends Migration
{
    ...
    public function up()
    {
        DB::statement("CREATE VIEW view_chart_history AS
                            SELECT b.user_id, p.product_name, p.slug, p.product_detail, bp.quantity, b.ongkir, bp.price, bp.price*bp.quantity AS subTotal, (bp.price*bp.quantity) + b.ongkir AS total
