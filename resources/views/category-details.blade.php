...
<link rel="stylesheet" type="text/css"
    href="{{asset('frontEnd/assets/plugins/jquery-ui-1.12.1.custom/jquery-ui.css')}}">
                            ...
                            <div class="product-grid"
                                ...
                                <a href="/product/{{$product->slug}}">
                                    <div class="product-item {{$product->id}} ">
                                        <div class="product discount product_filter">
                                            ...
                                            <div class="product_info">
                                                ...
                                                @else
                                                    ...
                                                    min="1" max="{{ $product->stok }}" value="1" style="width: 50px; margin-right: 10px;">
                                                @endif
                                                {{-- <h6>
                                        ...
                                        @if ($product->stok <= 0)
                                            <div class="add_to_cart_button red_button" style="margin-top: 40px;">
