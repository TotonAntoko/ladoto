...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote-bs4.css" rel="stylesheet"
          type="text/css">
    <link href="{{ asset('frontEnd/assets/plugins/font-awesome-4.7.0/css/font-awesome.min.css')}}" rel="stylesheet"
          type="text/css">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontEnd/assets/plugins/OwlCarousel2-2.2.1/owl.carousel.css') }}">
    <link rel="stylesheet" type="text/css"
          href="{{ asset('frontEnd/assets/plugins/OwlCarousel2-2.2.1/owl.theme.default.css') }}">
    ...
    <link href="{{asset("frontEnd/assets/styles/toastr.min.css")}}" rel="stylesheet">
