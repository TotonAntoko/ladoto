				...
				<div class="details-left">
						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="{{asset('frontEnd/images/product-slide/image1_thumb.jpg')}}" />
									<img class="etalage_source_image" src="{{asset('frontEnd/images/product-slide/image1_large.jpg')}}" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{asset('frontEnd/images/product-slide/image2_thumb.jpg')}}" />
								<img class="etalage_source_image" src="{{asset('frontEnd/images/product-slide/image2_large.jpg')}}" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{asset('frontEnd/images/product-slide/image3_thumb.jpg')}}" />
								<img class="etalage_source_image" src="{{asset('frontEnd/images/product-slide/image3_large.jpg')}}" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{asset('frontEnd/images/product-slide/image4_thumb.jpg')}}" />
								<img class="etalage_source_image" src="{{asset('frontEnd/images/product-slide/image4_large.jpg')}}" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{asset('frontEnd/images/product-slide/image5_thumb.jpg')}}" />
								<img class="etalage_source_image" src="{{asset('frontEnd/images/product-slide/image5_large.jpg')}}" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{asset('frontEnd/images/product-slide/image6_thumb.jpg')}}" />
								<img class="etalage_source_image" src="images/product-slide/image6_large.jpg')}}" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="{{asset('frontEnd/images/product-slide/image7_thumb.jpg')}}" />
								<img class="etalage_source_image" src="{{asset('frontEnd/images/product-slide/image7_large.jpg')}}" />
							</li>
						</ul>
					</div>
					<div class="details-left-info">
						<div class="details-right-head">
							...
							<p class="product-detail-info">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
						...
						<div class="similar-products-right">
							...
							<div id="owl-demo" class="owl-carousel">
								<div class="item" onclick="location.href='details.html';">
									<div class="product-grid fade sproduct-grid">
										<div class="product-pic">
											<a href="#"><img src="{{asset('frontEnd/images/product1.jpg')}}" title="product-name" /></a>
											<p>
								...
								<div class="item" onclick="location.href='details.html';">
									<div class="product-grid fade sproduct-grid">
										<div class="product-pic">
											<a href="#"><img src="{{asset('frontEnd/images/product2.jpg')}}" title="product-name" /></a>
											<p>
												<a href="#"><small>Nike</small> HYPERVENOM <small>Phantom</small> FG</a>
												<span>Men's Firm-Ground Football Boot</span>
											</p>
								...
								<div class="item" onclick="location.href='details.html';">
									<div class="product-grid fade sproduct-grid">
										<div class="product-pic">
											<a href="#"><img src="{{asset('frontEnd/images/product3.jpg')}}" title="product-name" /></a>
											<p>
												<a href="#"><small>Nike</small> HYPERVENOM <small>Phantom</small> FG</a>
												<span>Men's Firm-Ground Football Boot</span>
											</p>
								...
								<div class="item" onclick="location.href='details.html';">
									<div class="product-grid fade sproduct-grid">
										<div class="product-pic">
											<a href="#"><img src="{{asset('frontEnd/images/product4.jpg')}}" title="product-name" /></a>
											<p>
												<a href="#"><small>Nike</small> HYPERVENOM <small>Phantom</small> FG</a>
												<span>Men's Firm-Ground Football Boot</span>
											</p>
								...
								<div class="item" onclick="location.href='details.html';">
									<div class="product-grid fade sproduct-grid">
										<div class="product-pic">
											<a href="#"><img src="{{asset('frontEnd/images/product5.jpg')}}" title="product-name" /></a>
											<p>
												<a href="#"><small>Nike</small> HYPERVENOM <small>Phantom</small> FG</a>
												<span>Men's Firm-Ground Football Boot</span>
											</p>
