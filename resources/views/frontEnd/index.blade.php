    ...
    <div class="img-slider">
        <div class="wrap">
            <ul id="jquery-demo">
                <li>
                    <a href="#slide1">
                        <img src="{{asset('frontEnd/images/slide-1.jpg')}}" alt="" />
                    </a>
                    <div class="slider-detils">
                        <h3>MENS FOOT BALL <label>BOOTS</label></h3>
                        <span>Stay true to your team all day, every day, game day.</span>
                        <a class="slide-btn" href="/details"> Shop Now</a>
                    </div>
                </li>
                <li>
                    <a href="#slide2">
                        <img src="{{asset('frontEnd/images/slide-4.jpg')}}" alt="" />
                    </a>
                    <div class="slider-detils">
                        <h3>MENS FOOT BALL <label>BOOTS</label></h3>
                        <span>Stay true to your team all day, every day, game day.</span>
        ...
        <div class="wrap">
                ...
                <div class="content-left-bottom-grid">
                    ...
                    <div class="content-left-bottom-grids">
                        <div class="content-left-bottom-grid1">
                            <img src="{{asset('frontEnd/images/foot-ball.jpg')}}" title="football" />
                            <h5><a href="/details">Nike Strike PL Hi-Vis</a></h5>
                            <span> Football</span>
                            <label>&#163; 375</label>
                        </div>
                        <div class="content-left-bottom-grid1">
                            <img src="{{asset('frontEnd/images/jarse.jpg')}}" title="jarse" />
                            <h5><a href="/details">Nike Strike PL Hi-Vis</a></h5>
                            <span> Football</span>
                            <label>&#163; 375</label>
                        </div>
            ...
            <div class="content-right">
                <div class="product-grids">
                        ...
                        jQuery(function () {
                            jQuery('.starbox').each(function () {
                                ...
                                starbox.starbox({
                                    ...
                                    changeable: starbox.hasClass('unchangeable') ? false :
                                        starbox.hasClass('clickonce') ? 'once' : true,
                    ...
                    <!---caption-script---->
                    <!---//caption-script---->
                    <div onclick="location.href='/details';" class="product-grid fade">
                    ...
                    <div onclick="location.href='/details';" class="product-grid fade last-grid">
                        <div class="product-grid-head">
                            <ul class="grid-social">
                                <li><a class="facebook" href="#"><span> </span></a></li>
                                <li><a class="twitter" href="#"><span> </span></a></li>
                    ...
                    <div onclick="location.href='/details';" class="product-grid fade last-grid">
                        ...
                        <div class="product-pic">
                            <a href="#"><img src="{{asset('frontEnd/images/product6.jpg')}}" title="product-name" /></a>
                            <p>
                                <a href="#"><small>Nike</small> HYPERVENOM <small>Phantom</small> FG</a>
                                <span>Men's Firm-Ground Football Boot</span>
                            </p>
