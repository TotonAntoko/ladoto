                ...
                <li class="grid"><a class="color2" href="#">MEN</a>
                    <div class="megapanel">
                        <div class="row">
                            ...
                            <div class="col1 men">
                                <div class="men-pic">
                                    <img src="{{asset('frontEnd/images/men.png')}}" title="" />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col1">
                                ...
                                <div class="h_nav">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="/product">style videos</a></li>
                                        <li><a href="/product">accessories</a></li>
                                        <li><a href="/product">kids</a></li>
                                        <li><a href="/product">style videos</a></li>
                                    </ul>
                            ...
                            <div class="col1">
                                <div class="h_nav">
                                    ...
                                    <ul>
                                        <li><a href="/product">login</a></li>
                                        <li><a href="/product">create an account</a></li>
                                        <li><a href="/product">create wishlist</a></li>
                            ...
                            <div class="col1 women">
                                <div class="women-pic">
                                    <img src="{{asset('frontEnd/images/women.png')}}" title="" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <li><a class="color5" href="#">KIDS</a>
                    <div class="megapanel">
                        <div class="row">
                            ...
                            <div class="col1 kids">
                                <div class="kids-pic">
                                    <img src="{{asset('frontEnd/images/kids1.png')}}" title="" />
                                </div>
                            </div>
                            <div class="col1"></div>
                            <div class="col1"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col1 sports">
                                <div class="sports-pic">
                                    <img src="{{asset('frontEnd/images/sport.png')}}" title="" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                ...
                <li><a class="color7" href="#">NIKE SPORTSWEAR</a>
                    <div class="megapanel">
                        <div class="row">
                            ...
                            <div class="col1 nike">
                                <div class="nike-pic">
                                    <img src="{{asset('frontEnd/images/nike.png')}}" title="" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
